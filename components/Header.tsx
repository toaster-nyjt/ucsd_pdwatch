...
export default function Header() {
    return (
        <div 
            className="relative drop-shadow-2xl w-full h-[12vh] bg-rubber flex items-center justify-between rounded-b-[15px] px-8 py-6"
            style={{
        ...
        >
            ...
            <Link href="/">
                <span
                    className="text-black/60 text-[40px] hover:text-white/60 transition-colors cursor-pointer"
            ...
            <div className="flex gap-8">
                <Link href="/">
                    <span
                        className="text-black/60 text-[25px] hover:text-white/60 transition-colors cursor-pointer"
                        style={{ fontFamily: 'Monofett, monospace' }}
                    >
                        Home
                    </span>
                ...
                <svg width="24" height="13" viewBox="0 0 24 13" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <defs>
                        <filter id="filter0_i_17_693" x="0" y="0" width="25.274" height="14.6527" filterUnits="userSpaceOnUse" colorInterpolationFilters="sRGB">
                            ...
                            <feBlend mode="normal" in2="shape" result="effect1_innerShadow_17_693"/>
                        </filter>
                    </defs>
                </svg>
            </div>
