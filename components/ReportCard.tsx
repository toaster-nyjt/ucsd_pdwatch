...
export default function PDReportCard({ report }: { report: PDReport }) {
    return (
        <div className="rounded-[31px]" style={{ boxShadow: '0 2px 4px 3px rgba(0,0,0,0.25)' }}>
            <div className="text-black w-52.25 h-64.75 ring-[1px] ring-white/80 rounded-[31px] overflow-hidden flex flex-col">

                {/* Top Section */}
                <div className="flex flex-col justify-center gap-0 pl-3.75 pt-2.75 text-[10px] bg-dark-powder h-27.5">

                    {/* Category */}
                    <div className="flex items-center gap-2">
                        <svg className="shrink-0" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M8.09044 13.59C7.40153 13.5306 6.70431 13.5002 6 13.5002H5.25C2.76472 13.5002 0.75 11.4855 0.75 9.00021C0.75 6.51493 2.76472 4.50021 5.25 4.50021H6C6.70431 4.50021 7.40153 4.46987 8.09044 4.41043M8.09044 13.59C8.34329 14.5517 8.67372 15.4819 9.07463 16.3736C9.32209 16.924 9.13422 17.583 8.6116 17.8847L7.95529 18.2636C7.4039 18.582 6.6956 18.3808 6.42841 17.8029C5.8018 16.4475 5.31541 15.0141 4.98786 13.5212M8.09044 13.59C7.70517 12.1247 7.5 10.5864 7.5 9.00021C7.5 7.414 7.70518 5.87571 8.09044 4.41043M8.09044 13.59C11.25 13.8626 14.2345 14.7474 16.9247 16.1251M8.09044 4.41043C11.25 4.13782 14.2345 3.25304 16.9247 1.8753M16.9247 1.8753C16.807 1.49616 16.6802 1.12104 16.5444 0.750214M16.9247 1.8753C17.4597 3.59849 17.8057 5.40484 17.9386 7.27013M16.9247 16.1251C16.807 16.5043 16.6802 16.8794 16.5444 17.2502M16.9247 16.1251C17.4597 14.4019 17.8057 12.5956 17.9386 10.7303M17.9386 7.27013C18.4344 7.68285 18.75 8.30468 18.75 9.00021C18.75 9.69575 18.4344 10.3176 17.9386 10.7303M17.9386 7.27013C17.9793 7.84152 18 8.41845 18 9.00021C18 9.58197 17.9793 10.1589 17.9386 10.7303"
                            stroke="#0F172A" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                        </svg>
                        <span className="flex-1 text-right font-extrabold line-clamp-2 pr-2">{report.category}</span>
                    </div>

                    {/* Location */}
                    <div className="flex items-center gap-2 pl-0.5">
                        <svg className="shrink-0 min-w-4.25" width="17" height="21" viewBox="0 0 17 21" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M11.25 8.25C11.25 9.90685 9.90685 11.25 8.25 11.25C6.59315 11.25 5.25 9.90685 5.25 8.25C5.25 6.59315 6.59315 5.25 8.25 5.25C9.90685 5.25 11.25 6.59315 11.25 8.25Z" stroke="#0F172A" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                            <path d="M15.75 8.25C15.75 15.3921 8.25 19.5 8.25 19.5C8.25 19.5 0.75 15.3921 0.75 8.25C0.75 4.10786 4.10786 0.75 8.25 0.75C12.3921 0.75 15.75 4.10786 15.75 8.25Z" stroke="#0F172A" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                        </svg>
                        <span className="flex-1 text-right line-clamp-2 pr-2">{report.location}</span>
                    </div>

                    {/* Time */}
                    <div className="flex items-center gap-2">
                        <svg className="shrink-0" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M9.75 3.75V9.75H14.25M18.75 9.75C18.75 14.7206 14.7206 18.75 9.75 18.75C4.77944 18.75 0.75 14.7206 0.75 9.75C0.75 4.77944 4.77944 0.75 9.75 0.75C14.7206 0.75 18.75 4.77944 18.75 9.75Z"
                            stroke="#0F172A" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                        </svg>
                        <span className="flex-1 text-right pr-2">
                            {(report.time != "00:00:00") ? (new Intl.DateTimeFormat('en-US', {hour: '2-digit', minute: '2-digit', hour12: true})
                            .format(new Date(`1970-01-01T${report.time}`))) : ('N/A')}
                        </span>
                    </div>
                    ...
                    <div className="flex items-center gap-2">
                        <svg className="shrink-0" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M4.5 0.75V3M15 0.75V3M0.75 16.5V5.25C0.75 4.00736 1.75736 3 3 3H16.5C17.7426 3 18.75 4.00736 18.75 5.25V16.5M0.75 16.5C0.75 17.7426 1.75736 18.75 3 18.75H16.5C17.7426 18.75 18.75 17.7426 18.75 16.5M0.75 16.5V9C0.75 7.75736 1.75736 6.75 3 6.75H16.5C17.7426 6.75 18.75 7.75736 18.75 9V16.5"
                            stroke="#0F172A" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                        </svg>
                        <span className="flex-1 text-right pr-2">
                            {(report.date != "1970/01/01") ? (new Date(report.date.replaceAll("-", "/"))).toDateString() : ('N/A')}
                        </span>
                    </div>
